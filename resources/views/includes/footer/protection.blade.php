@section('css')
    <link rel="stylesheet" type="text/css" href="{{asset('/css/guest/protection.css')}}">
    ...
    <div class="fake-body dataprotection">
        ...
        <div class="sub-header">
            <div class="sub-header-div">
                <img class="sub-header-image" src="{{asset('img/guest/protection.gif')}}" alt="Bild">
                <h2 class="sub-header-text">Protection</h2>
            </div>
        </div>
